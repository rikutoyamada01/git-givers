...
[日本語の貢献ガイドラインはこちら](CONTRIBUTING.ja.md)
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/yamadarikuto/git-karma/issues) that might help you. In case you've found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/yamadarikuto/git-karma/issues/new).
...
- Search the existing [Issues](https://github.com/yamadarikuto/git-karma/issues) to see if the bug has already been reported.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/yamadarikuto/git-karma/issues).
